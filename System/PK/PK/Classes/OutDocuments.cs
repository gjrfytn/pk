        ...
        public class Entrant
        {
                ...
                IEnumerable<Tuple<uint, byte>> marks)
            {
                ...
                List<string> parameters = new List<string>
                {
                    ...
                    math.ToString(),
                    applData.Hostel?"XXX":"",
                    applData.PassingExam.HasValue&&applData.PassingExam.Value?"XXX":"",
                    rus.ToString(),
                    applData.Chernobyl.HasValue&&applData.Chernobyl.Value?"XXX":"",
                    applData.MCADO.HasValue&&applData.MCADO.Value?"XXX":"",
                    phys.ToString(),
                    target?"XXX":"",
